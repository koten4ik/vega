...
class NestedSetBehavior extends CActiveRecordBehavior
{
	...
	public function beforeSave($event)
	{
		if($this->_ignoreEvent)
			...
			throw new CDbException(Yii::t('yiiext','You should not use ActiveRecord::save() method when NestedSetBehavior attached.'));
	}
	...
	public function beforeDelete($event)
	{
		if($this->_ignoreEvent)
			...
			throw new CDbException(Yii::t('yiiext','You should not use ActiveRecord::delete() method when NestedSetBehavior attached.'));
	}

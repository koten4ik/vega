...
<?php $form=$this->beginWidget('CCodeForm', array('model'=>$model)); ?>
	...
	<div class="row">
		<?php echo '<span style="color:red">!!Module ID/</span>Controller ID<br>'; ?>
	...
	<div class="row sticky">
        ...
        <?php echo $form->dropDownList($model,'baseControllerClass',
            array(''=>'','BackEndController'=>'BackEndController','FrontEndController'=>'FrontEndController')
        ); ?>
		<div class="tooltip">

...
class CrudCode extends CCodeModel
{
    ...
    public function getEndPath()
  	{
        $path = '';
        //if($this->baseControllerClass == 'BackEndController') $path = 'backend/';
        //if($this->baseControllerClass == 'FrontEndController') $path = 'frontend/';
  		return $path;
  	}
	...
	public function getControllerFile()
	{
		...
		return $module->getControllerPath().'/'.$this->getEndPath().$id.'Controller.php';
	}

	public function getViewPath()
	{
		return $this->getModule()->getViewPath().'/'.$this->getEndPath().$this->getControllerID();
	}
	...
	{
		return "\$form->labelEx(\$model,'{$column->name}', array('style'=>''))";
	}

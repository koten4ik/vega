...
/**
 * This is the model class for table "{{banner_view}}".
 *
 * The followings are the available columns in table '{{banner_view}}':
 * @property integer $id
 ...
 */
class BannerView extends ActiveRecord
{
    public $published = 1;
    public $position = 0;
    public $no_log = true;
	...
	public function tableName(){ return '{{banner_view}}'; }

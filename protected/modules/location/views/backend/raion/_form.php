...
<div class="form pad">
<?php $form=$this->beginWidget('ActiveForm', array('id'=>'location-raion-form')); ?>

    <label class="ib">Область</label>
    <? $this->widget('LocationMultiWidget', array('id'=>'location_model','model_name'=>$this->modelName,
            'fields'=>array( 'country_id'=>$model->country_id, 'oblast_id'=>$model->oblast_id, null, null
    )));?>
    <br>
